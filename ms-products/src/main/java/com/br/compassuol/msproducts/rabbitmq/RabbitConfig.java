package com.br.compassuol.msproducts.rabbitmq;
...
public class RabbitConfig {
    ...
    public static final String RPC_MESSAGE_QUEUE = "product_msg_queue";
    public static final String RPC_REPLY_MESSAGE_QUEUE = "product_reply_queue";
    public static final String RPC_EXCHANGE = "product_exchange";
    /** *
